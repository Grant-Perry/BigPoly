...
/// This SwiftUI view is designed to present an interactive LookAround scene based on the location data associated with a workout.
...
//	@State private var retScene: String = "Valid"
	...
	func getLookAroundScene() {
		...
		Task {
			// Check if there are coordinates available in `workoutData`.
